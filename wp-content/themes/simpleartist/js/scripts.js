// Galería
$(function(){
      $(".featured").attr("src", "assets/img/2018-1.jpg")
...
$(function(){
      ...
      if(slidy == null || slidy.length <= 0 || typeof slidy == undefined){
        return;
      }
...
// API & MAPA
  	...
  	var coords = {
  		vin: '-33.0280812,-71.552522',
  		vlp: '-33.0438602,-71.6271817',
  		qta: '-33.0206282,-71.5465233',
  		pta: '-33.0384613,-71.6270877'
  	}
    ...
    // var text = $('#select option:selected').text();
      ...
      if(map_id != null && map_id !== "null"){

    		var text = $('').text();
    		var coord = {lat: -33.0280812, lng: -71.552522};
    		map = new google.maps.Map(map_id, {zoom: 15, center: coord});
    		//Creamos marcador
